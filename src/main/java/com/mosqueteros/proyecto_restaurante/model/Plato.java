...
public class Plato {
    ...
    public void setCosto(BigDecimal c) {
        this.costo = c;
    }

    public long getCategoriaPlatoId() {
        return categoriaPlatoId;
    }

    public void setCategoriaPlatoId(long c) {
        this.categoriaPlatoId = c;
    }
    ...
    public void setCategoriaDesc(String c) {
        this.categoriaDesc = c;
    }
    ...
    public void setEstadoDesc(String e) {
        this.estadoDesc = e;
    }
